        ...
        <div className="about-grid">
          <div className="grid1">
            ...
            <p className="paragraph">
              ...
              nossa interface intuitiva e recursos avançados de segurança, você
              pode comprar, vender, armazenar e até mesmo gastar suas
              criptomoedas com total confiança.
            </p>
          </div>
          <div className="grid2">
            ...
            <p className="paragraph">
              ...
              transações rápidas, seguras e sem contato. Com reconhecimento
              facial e biométrico, as transações ficam mais simples e
              protegidas.
            </p>
          </div>
          <div className="grid3">
            ...
            <p className="paragraph">
              ...
              programas de recompensas para incentivar seu uso contínuo. Além
              disso, nossa plataforma está em constante evolução, com novos
              recursos e parcerias sendo adicionados regularmente para melhor
          ...
          <div className="grid4">
            ...
            <p className="paragraph">
              ...
              benefícios que nossa plataforma tem a oferecer!
            </p>
          </div>
        </div>
      </div>
